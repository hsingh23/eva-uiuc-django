...
MEDIA_ROOT = os.path.join(SITE_ROOT, 'eva_uiuc_app/media/')
...
STATIC_ROOT = os.path.join(SITE_ROOT, 'eva_uiuc_app/static/')
...
SECRET_KEY = '2hcc&amp;k5!gijbl!ylj)j%rzj&amp;h%=0654*&amp;8h$d-j1&amp;byi9v@ov4'
...
TEMPLATE_DIRS = (os.path.join(SITE_ROOT, 'eva_uiuc_app/templates'),)
